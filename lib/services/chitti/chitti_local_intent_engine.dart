...
class ChittiLocalIntentEngine {
  ...
  static const List<_IntentRule> _rules = <_IntentRule>[
    ...
    // github" phrasing resolves locally, matching the tool's own
    // optional `url` (defaults to the PR list) — a specific "open PR
    // #42" needs the model to build the actual URL.
    _IntentRule(
      action: 'open_admin_browser',
      variants: {'admin'},
      phrases: [
        'open github',
        'open the browser',
    ...
    _IntentRule(
      ...
      phrases: [
        'any customer enquiries waiting',
        'open enquiries',
        'enquiries',
        'customer enquiry',
        'price questions',
    ...
    _IntentRule(
      ...
      phrases: [
        ...
        'db audit',
        'database audit',
        'check database leakage',
        'check for db leakage',
        'db leakage',
        'audit panu',
        'டேட்டாபேஸ் ஆடிட்',
        'ஆடிட் பண்ணு',
