...
const _njServices = [
  ...
  {
    'icon': FluentEmojiFlat.hammer_and_wrench,
    'label': 'Repairs',
    'id': 'repairs',
  },
  {
    'icon': FluentEmojiFlat.delivery_truck,
    'label': 'Delivery',
    'id': 'delivery',
  },
];
  ...
  void _tap(String id) {
    switch (id) {
      ...
      case 'carwash':
        ...
        break;
      case 'puncture':
        _navigate(const ComingSoonScreen(role: 'Mobile Puncture'));
        break;
      case 'construction':
        _navigate(const ConstructionScreen());
        break;
      case 'custom':
        _navigate(const CustomOrderScreen());
        break;
      case 'mobile':
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Erode, TN',
                  style:
                      TextStyle(color: kMuted, fontSize: 9, letterSpacing: 0.5),
                ),
              ],
            ),
          ),
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border:
                    Border.all(color: kPink.withValues(alpha: 0.35), width: 2),
                boxShadow: [
                  BoxShadow(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () => Navigator.push<void>(
              context,
              MaterialPageRoute<void>(
                builder: (_) => const CustomFoodOrderScreen(),
              ),
            ),
            child: Container(
              width: double.infinity,
              ...
              child: Row(
                ...
                children: [
                  ...
                  SvgPicture.string(
                    FluentEmojiFlat.pizza,
                    width: 32,
                    height: 32,
                  ),
                  SvgPicture.string(
                    FluentEmojiFlat.chicken,
                    width: 32,
                    height: 32,
                  ),
                  SvgPicture.string(
                    FluentEmojiFlat.french_fries,
                    width: 32,
                    height: 32,
                  ),
                  SvgPicture.string(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () => Navigator.push<void>(
              context,
              MaterialPageRoute<void>(
                builder: (_) => const NJTechStoreScreen(),
              ),
            ),
            child: Container(
              width: double.infinity,
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(16),
                border:
                    Border.all(color: kBlue.withValues(alpha: 0.2), width: 1.5),
              ),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(16),
                border:
                    Border.all(color: kTeal.withValues(alpha: 0.2), width: 1.5),
              ),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
          ...
          Row(
            ...
            children: [
              ...
              Container(
                padding: const EdgeInsets.all(6),
                decoration: BoxDecoration(
                  color: printColor.withValues(alpha: 0.1),
                  shape: BoxShape.circle,
                ),
                child: const Icon(
                  Icons.arrow_forward_ios_rounded,
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(16),
                border: Border.all(
                  color: printColor.withValues(alpha: 0.2),
                  width: 1.5,
                ),
              ),
              child: Row(
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                _buildSmallActionTile(
                  context,
                  FluentEmojiFlat.motorcycle,
                  'Puncture',
                  () => Navigator.push<void>(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const ComingSoonScreen(
                        role: 'Mobile Puncture',
                      ),
                    ),
                  ),
                ),
                ...
                _buildSmallActionTile(
                  ...
                  () => Navigator.push<void>(
                    ...
                    MaterialPageRoute(
                      builder: (_) =>
                          const ComingSoonScreen(role: 'Electrician'),
                    ),
                  ),
                ),
              ],
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Place custom orders & get support — tap to start',
                          style: TextStyle(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Text(
                            'Get your Guru AI subscription for 1yr free',
                            style: GoogleFonts.outfit(
                              color: kText,
                              fontSize: 12,
                              fontWeight: FontWeight.w700,
                      ...
                      const SizedBox(height: 2),
                      const Text(
                        'Visit NJ TECH to unlock the 1-year free Guru AI offer.',
      ...
      child: Column(
        ...
        children: [
          ...
          _apkBtn(
            ...
            url:
                'https://github.com/myallin1/Allin1-update-release/releases/latest/download/customer_app.apk',
          ),
          const SizedBox(height: 10),
          _apkBtn(
            ...
            url:
                'https://github.com/myallin1/Allin1-update-release/releases/download/v1.0.0/hero_app.apk',
          ),
          const SizedBox(height: 16),
          GestureDetector(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 6),
          Text(
            _revealed ? '🎊 Revealed!' : 'Keep scratching...',
            style: GoogleFonts.outfit(
  ...
  final List<_CategorySlideData> _slides = const [
    ...
    _CategorySlideData(
      ...
      icons: [
        ...
        FluentEmojiFlat.chicken,
        FluentEmojiFlat.french_fries,
        FluentEmojiFlat.cup_with_straw,
        FluentEmojiFlat.shortcake,
      ],
    ),
    _CategorySlideData(
