          ...
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: (assigned ? Colors.green : _kPink)
                ...
                children: [
                  AnimatedContainer(
                    ...
                    child: Icon(
                          ...
                          ? (active ? steps[i].icon : Icons.check_rounded)
                          : steps[i].icon,
                      color: done ? Colors.white : _kMuted,
                      size: 18,
                    ),
                  ),
                  if (!isLast)
                    ...
                    children: [
                      ...
                      if (active && status == 'placed')
                        Text(
                          ...
                          style:
                              GoogleFonts.outfit(color: _kPink, fontSize: 11),
                        ),
                    ],
                  ),
                ),
