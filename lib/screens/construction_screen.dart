...
const _services = [
  _ConstructionService(
    ...
    subtitle: 'Expert architectural planning, 3D blueprints & structural design for your dream home',
    price: 'Free Quote',
    badge: 'MOST BOOKED',
    badgeColor: _kGold,
    imageUrl:
        'https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=800&q=80',
    features: ['3D Blueprint', 'Vastu Compliance', 'Govt Approval Help', 'Timeline Plan'],
  ),
  _ConstructionService(
    title: 'Renovation & Repair',
    subtitle: 'Full home renovation, crack repair, waterproofing & structural strengthening',
  ...
  _ConstructionService(
    ...
    subtitle: 'Premium modular kitchen, false ceiling, wardrobes & complete home styling',
    price: 'Call for Quotation',
    badge: 'PREMIUM',
    badgeColor: _kPink,
    imageUrl:
        'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=800&q=80',
    features: ['Modular Kitchen', 'False Ceiling', 'Wardrobes', '3D Walkthrough'],
  ),
];
          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildBuilderDelegate(
                ...
                // it. The pinned bottom bar still has Call/WA, so contact
                // is always reachable — this just removes the redundant
...
class _ServiceCard extends StatelessWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<_ConstructionService>('service', service));
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Column(crossAxisAlignment: CrossAxisAlignment.start,
          ...
          Text('Get a Quote', style: GoogleFonts.outfit(
