...
exports.releaseHoldInternal = exports.MAX_CONCURRENT_HOLDS_PER_CUSTOMER = exports.MAX_QUANTITY_PER_ITEM = exports.HOLD_TTL_MINUTES = exports.db = void 0;
const admin = __importStar(require("firebase-admin"));
if (admin.apps.length === 0) {
    admin.initializeApp();
}
exports.db = admin.firestore();
exports.HOLD_TTL_MINUTES = 15;
...
exports.MAX_QUANTITY_PER_ITEM = 500;
...
exports.MAX_CONCURRENT_HOLDS_PER_CUSTOMER = 5;
/**
 ...
 */
async function releaseHoldInternal(holdId, newStatus) {
    const holdRef = exports.db.collection('stock_holds').doc(holdId);
    return exports.db.runTransaction(async (transaction) => {
        ...
        const itemsRef = exports.db.collection('sellers').doc(sellerId).collection('menu_items');
...
//# sourceMappingURL=stockHoldHelpers.js.map